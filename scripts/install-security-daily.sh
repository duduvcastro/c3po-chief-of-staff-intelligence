...
python3 scripts/init-maintenance-gate.py "$root"
install -o root -g root -m 0644 c3po/backend/app/maintenance_gate.py /usr/local/lib/c3po-security/maintenance_gate.py
if [ ! -e runtime/security/deployment.lock ]; then
  install -o ubuntu -g ubuntu -m 0644 /dev/null runtime/security/deployment.lock
fi
install -o root -g root -m 0755 scripts/c3po_security_daily.py scripts/c3po_security_watchdog.py scripts/c3po_maintenance_run.py /usr/local/lib/c3po-security/
install -o root -g root -m 0644 scripts/c3po_dependency_security.py scripts/c3po_security_reboot.py scripts/c3po_security_guard.py scripts/c3po_security_schedulers.py scripts/c3po_container_remediation.py scripts/c3po_trivy_scan.py /usr/local/lib/c3po-security/
