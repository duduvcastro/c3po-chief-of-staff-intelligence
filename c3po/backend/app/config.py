...
class Settings(BaseSettings):
    ...
    auth_owner_idle_minutes: int = Field(default=360, ge=1, le=1440)
    auth_member_idle_minutes: int = Field(default=60, ge=1, le=1440)
    ...
    r2d2_fast_risk_watcher_enabled: bool = False
