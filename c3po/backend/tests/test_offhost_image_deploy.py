...
def test_all_services_use_the_three_named_runtime_images() -> None:
...
def test_production_builds_and_transfers_images_before_connecting_to_host() -> None:
    ...
    assert (
        "docker save c3po/backend:production c3po/web:production "
        "c3po/database:production"
    ) in workflow
